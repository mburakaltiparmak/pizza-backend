...
public interface OrderRepository extends JpaRepository<Order, Long> {
        ...
        /**
         * Tüm siparişleri detaylarıyla getir (WITH SORT)
         */
        @Query("SELECT DISTINCT o FROM Order o " +
                        "LEFT JOIN FETCH o.user " +
                        "LEFT JOIN FETCH o.items oi " +
        ...
        /**
         * Kullanıcıya göre siparişleri getir (WITH SORT)
         */
        @Query("SELECT DISTINCT o FROM Order o " +
                        "LEFT JOIN FETCH o.items oi " +
                        "LEFT JOIN FETCH oi.product " +
                        "WHERE o.user = :user")
        List<Order> findByUserWithDetails(@Param("user") User user, Sort sort);

        /**
         * Statüye göre siparişleri getir (WITHOUT PAGINATION)
         *
         * @deprecated Use {@link #findByOrderStatusWithDetails(OrderStatus, Pageable)}
         *             for pagination
         */
        @Query("SELECT DISTINCT o FROM Order o " +
                        "LEFT JOIN FETCH o.user " +
        ...
        /**
         * Statüye göre siparişleri getir (WITH SORT)
         */
        @Query("SELECT DISTINCT o FROM Order o " +
                        "LEFT JOIN FETCH o.user " +
                        "LEFT JOIN FETCH o.items oi " +
                        "LEFT JOIN FETCH oi.product " +
                        "WHERE o.orderStatus = :status")
        List<Order> findByOrderStatusWithDetails(@Param("status") OrderStatus status, Sort sort);
        ...
        /**
         * Sipariş detaylarını UUID ile getir (Secure Tracking)
         */
        @Query("SELECT DISTINCT o FROM Order o " +
                        "LEFT JOIN FETCH o.user " +
                        "LEFT JOIN FETCH o.items oi " +
                        "LEFT JOIN FETCH oi.product " +
                        "WHERE o.uuid = :uuid")
        Optional<Order> findByUuidWithDetails(@Param("uuid") java.util.UUID uuid);
        ...
        @Query(value = "SELECT DISTINCT o FROM Order o " +
                        ...
                        "LEFT JOIN FETCH o.items oi " +
                        "LEFT JOIN FETCH oi.product " +
                        "ORDER BY o.orderDate DESC", countQuery = "SELECT COUNT(DISTINCT o) FROM Order o")
        ...
        @Query(value = "SELECT DISTINCT o FROM Order o " +
                        ...
                        "LEFT JOIN FETCH oi.product " +
                        "WHERE o.user = :user " +
                        "ORDER BY o.orderDate DESC", countQuery = "SELECT COUNT(DISTINCT o) FROM Order o WHERE o.user = :user")
         ...
         * Pageable pageable = PageRequest.of(0, 20, Sort.by("orderDate").descending());
         * Page<Order> orders =
         * repository.findByOrderStatusWithDetails(OrderStatus.PENDING, pageable);
         *
        ...
        @Query(value = "SELECT DISTINCT o FROM Order o " +
                        ...
                        "LEFT JOIN FETCH oi.product " +
                        "WHERE o.orderStatus = :status " +
                        "ORDER BY o.orderDate DESC", countQuery = "SELECT COUNT(DISTINCT o) FROM Order o WHERE o.orderStatus = :status")
